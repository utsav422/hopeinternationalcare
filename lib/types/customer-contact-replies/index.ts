...
export type CustomerContactReplyBase = InferSelectModel<
    typeof customerContactReplies
>;
export type CustomerContactReplyInsert =
    typeof customerContactReplies.$inferInsert;

// Related types
export type TypeCustomerContactReplyEmailStatus =
    | 'sent'
    | 'delivered'
    | 'bounced'
    | 'failed';
...
export type CustomerContactReplyUpdateData = Partial<
    Pick<CustomerContactReplyInsert, 'subject' | 'message'>
> & {
    id: string;
};
...
// Batch reply result type
export interface CustomerContactBatchReplyResult {
    batch_id: string;

 ...
 */
export async function adminEnrollmentDetailsByIdCompat(id: string) {
    const { data, success, error, code, details } =
        await adminEnrollmentDetails(id);
 ...
 */
export async function adminEnrollmentDetailsWithJoinsByIdCompat(id: string) {
    const { data, success, error, code, details } =
        await adminEnrollmentDetails(id);
...
export async function adminEnrollmentListByUserId(userId: string) {
    const { success, data, error, code, details } =
        await cachedAdminEnrollmentList({ userId });
 ...
 */
export async function adminEnrollmentDetailsWithPaymentByIdCompat(id: string) {
    const { data, success, error, code, details } =
        await adminEnrollmentDetails(id);
...
export async function adminEnrollmentListAll() {
    const { data, success, error, code, details } =
        await cachedAdminEnrollmentList({});
...
export async function adminEnrollmentListAllByStatus(
    ...
    const { data, success, error, code, details } =
        await cachedAdminEnrollmentList({ status });
 ...
 */
export async function adminEnrollmentUpsertCompat(
    ...
    try {
        ...
        return result.success && result.data
            ? { success: true, data: result.data.enrollment }
 ...
 */
export async function adminEnrollmentUpdateStatusByIdCompat(
    id: string,
    status: TypeEnrollmentStatus,
    cancelled_reason?: string
) {
    const { data, success, error, code, details } =
        await adminEnrollmentUpdateStatus({
            id,
            status,
            cancelled_reason,
            notify_user: true,
 ...
 */
export async function adminEnrollmentDeleteByIdCompat(id: string) {
    const { data, success, error, code, details } =
        await adminEnrollmentDelete(id);
...
export const cachedAdminEnrollmentDetailsWithJoinsById =
    cachedAdminEnrollmentDetails;
export const cachedAdminEnrollmentListByUserId = cachedAdminEnrollmentList;
export const cachedAdminEnrollmentDetailsWithPaymentById =
    cachedAdminEnrollmentDetails;

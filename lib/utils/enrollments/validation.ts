...
import { type EnrollmentWithDetails, type EnrollmentCreateData, EnrollmentValidationError } from '@/lib/types/enrollments';
...
export function validateEnrollmentStatusTransition(
  ...
  const validTransitions: Record<TypeEnrollmentStatus, TypeEnrollmentStatus[]> = {

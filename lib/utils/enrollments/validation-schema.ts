...
export const enrollmentCreateSchema = z.object({
    ...
    status: z
        .enum(['requested', 'enrolled', 'completed', 'cancelled'])
        .optional(),
...
export const enrollmentBulkStatusUpdateSchema = z.object({
    ids: z
        .array(z.string().uuid('Invalid enrollment ID'))
 ...
 */
export function validateEnrollmentCreateData(
    data: unknown
 ...
 */
export function validateEnrollmentStatusUpdate(
    data: unknown
 ...
 */
export function validateEnrollmentQueryParams(
    params: unknown
 ...
 */
export function validateEnrollmentBulkStatusUpdate(data: unknown): {
    ids: string[];
    status: string;

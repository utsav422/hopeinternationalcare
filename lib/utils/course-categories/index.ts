 ...
 */
export function validateCourseCategoryData(
    data: CourseCategoryCreateData | CourseCategoryUpdateData
) {
    try {
 ...
 */
export async function checkCourseCategoryConstraints(
    id: string
): Promise<CourseCategoryConstraintCheck> {
    try {
 ...
 */
export function canUpdateCategoryName(
    currentName: string,
    newName: string
): boolean {

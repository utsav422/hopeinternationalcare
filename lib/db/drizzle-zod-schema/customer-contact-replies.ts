...
export const ZodCustomerContactReplyInsertSchema = createInsertSchema(customerContactReplies, {
...
export const ZodCustomerContactReplySelectSchema = createSelectSchema(customerContactReplies);

export type ZodCustomerContactReplyInsertType = z.infer<typeof ZodCustomerContactReplyInsertSchema>;
export type ZodCustomerContactReplySelectType = z.infer<typeof ZodCustomerContactReplySelectSchema>;
...
export const CustomerContactReplySchema = z.object({
  ...
  replyToName: z.string().min(1, 'Name is required').max(255, 'Name too long'),
});

// Schema for batch reply (API input)
export const CustomerContactBatchReplySchema = z.object({
  contactRequestIds: z.array(z.string().uuid('Invalid contact request ID'))
...
export type CreateCustomerContactReplyType = z.infer<typeof CreateCustomerContactReplySchema>;
...
export const UpdateCustomerContactReplyStatusSchema = z.object({
  ...
  email_status: z.enum(['sent', 'delivered', 'bounced', 'failed', 'opened', 'clicked']),
...
export type UpdateCustomerContactReplyStatusType = z.infer<typeof UpdateCustomerContactReplyStatusSchema>;

...
import type {courseCategories, courses, intakes, profiles,} from '../schema/index';
...
export const ZodAdminEnrollmentQuerySchema = z.object({
...
export type ZodAdminEnrollmentQueryType = z.infer<typeof ZodAdminEnrollmentQuerySchema>;

export const queryKeys = {
    affiliations: {
        ...
        list: (params: object) =>
            [...queryKeys.affiliations.lists(), params] as const,
        details: () => [...queryKeys.affiliations.all, 'detail'] as const,
        detail: (id: string) =>
            [...queryKeys.affiliations.details(), id] as const,
    },
    courseCategories: {
    ...
    intakes: {
        ...
        list: (params: object) =>
            [...queryKeys.intakes.lists(), params] as const,
    ...
    profiles: {
        ...
        list: (params: object) =>
            [...queryKeys.profiles.lists(), params] as const,
    ...
    refunds: {
        ...
        list: (params: object) =>
            [...queryKeys.refunds.lists(), params] as const,
    },
    customerContactRequests: {
        all: ['customer-contact-requests'] as const,
        lists: () =>
            [...queryKeys.customerContactRequests.all, 'list'] as const,
        list: (params: object) =>
    ...
    publicCourses: {
        ...
        detail: (id: string) =>
            [...queryKeys.publicCourses.details(), id] as const,
    },
    userPaymentHistory: {

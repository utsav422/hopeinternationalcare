...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 px-4 py-12 text-center sm:px-6 lg:px-8 dark:bg-gray-900">
      <h1 className="mb-4 font-extrabold text-6xl text-gray-900 tracking-tight sm:text-7xl lg:text-8xl dark:text-white">
        404
      </h1>
      <h2 className="mb-4 font-bold text-2xl text-gray-800 sm:text-3xl dark:text-gray-200">
        Page Not Found
      </h2>
      <p className="mb-8 text-gray-600 text-lg sm:text-xl dark:text-gray-400">

    ...
    <section className="bg-gray-50 py-20 sm:py-28 dark:bg-gray-900" ref={ref}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            className="mx-auto mt-4 max-w-2xl text-gray-600 text-xl dark:text-gray-400"
            variants={itemVariants}
          >
        ...
        >
          {CourseList.map(({ image, title }) => (
            ...
            >
              ...
              <h3 className="mt-4 font-bold text-base text-gray-800 transition-colors duration-300 group-hover:text-teal-600 sm:text-lg dark:text-gray-200 dark:group-hover:text-teal-400">
                {title}
              </h3>
            </motion.div>
          ))}

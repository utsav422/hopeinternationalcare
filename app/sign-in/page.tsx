                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    {...field}
                                                    className="w-full border-gray-300 bg-gray-100 text-gray-800 placeholder:text-gray-400 focus:border-teal-500 focus:ring-teal-500 dark:border-gray-600 dark:bg-gray-700  dark:placeholder:text-gray-500"

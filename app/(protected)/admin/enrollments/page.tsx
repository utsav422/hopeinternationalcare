...
export default async function EnrollmentsPage({params: promisedParams, searchParams: promisedSearchParams}: {
    params: Promise<{}>;
    ...
    } = await normalizeProps(IdParamsSchema, ZodAdminEnrollmentQuerySchema, _params, searchParams);

...
export default async function Enrollments({params: promisedParams, searchParams: promisedSearchParams}: {
    ...
    try {
        ...
        await queryClient.prefetchQuery({
            ...
            queryFn: () => cachedAdminEnrollmentDetailsById(validatedParams.id as string),
        });
    } catch (error) {

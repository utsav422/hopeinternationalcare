...
export default async function IntakeDetailsPage({params: promisedParams, searchParams: promisedSearchParams}: {
    ...
    const {
        params: validatedParams, searchParams: validatedSearchParams
    } = await normalizeProps(IdParamsSchema, ZodAdminIntakeQuerySchema, params, searchParams);
    ...
    try {
        ...
        await queryClient.prefetchQuery({
            ...
            queryFn: () => cachedAdminIntakeDetailsById(validatedParams.id as string),
        });
    } catch (error) {

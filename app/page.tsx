...
import { ReviewStructuredData, LocalBusinessStructuredData, ServiceStructuredData } from '@/components/SEO/StructuredData';
...
const testimonials = [
    ...
    },
    {
        ...
        reviewBody: 'Fantastic course with great course content. I have learned so much in such a short period.',
        ratingValue: 5,
    ...
    },
    {
        ...
        reviewBody: 'I am very much satisfied with their course and teaching method.',
        ratingValue: 5,
...
const services = [
    {
        ...
        description: 'Are you passionate about providing compassionate care to the elderly? Our comprehensive caregiver training packages are designed to equip you with the essential skills and knowledge needed to excel in the field of elderly care.',
    ...
    },
    {
        ...
        description: 'Ready to take the next step in your career in elderly care? Our personalized career guidance and support services are here to help you navigate your professional journey with confidence.',
        provider: 'Hope International',

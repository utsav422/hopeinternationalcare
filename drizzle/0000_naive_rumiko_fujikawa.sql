...
CREATE TYPE "public"."enrollment_status" AS ENUM('requested', 'enrolled', 'cancelled');--> statement-breakpoint
...
CREATE POLICY "admin can manage courses" ON "courses" AS PERMISSIVE FOR ALL TO "service_role" USING ((auth.jwt() ->> 'role') = 'service_role') WITH CHECK (true);--> statement-breakpoint
...
CREATE POLICY "authenticated users can create enrollments" ON "enrollments" AS PERMISSIVE FOR SELECT TO public USING ((auth.jwt() ->> 'role') = 'authenticated');--> statement-breakpoint
CREATE POLICY "anyone can read courses" ON "enrollments" AS PERMISSIVE FOR SELECT TO public USING (true);--> statement-breakpoint
...
CREATE POLICY "admin can manage intakes" ON "intakes" AS PERMISSIVE FOR ALL TO "service_role" USING ((auth.jwt() ->> 'role') = 'service_role') WITH CHECK (true);--> statement-breakpoint
...
CREATE POLICY "admin can manage payments" ON "payments" AS PERMISSIVE FOR ALL TO "service_role" USING ((auth.jwt() ->> 'role') = 'service_role') WITH CHECK (true);--> statement-breakpoint
...
CREATE POLICY "User can update own profile" ON "profiles" AS PERMISSIVE FOR SELECT TO public USING (auth.uid() = "profiles"."id");--> statement-breakpoint
CREATE POLICY "admin can manage profile" ON "profiles" AS PERMISSIVE FOR ALL TO "service_role" USING ((auth.jwt() ->> 'role') = 'service_role') WITH CHECK (true);--> statement-breakpoint
...
CREATE POLICY "admin can manage intakes" ON "refunds" AS PERMISSIVE FOR ALL TO "service_role" USING ((auth.jwt() ->> 'role') = 'service_role') WITH CHECK (true);
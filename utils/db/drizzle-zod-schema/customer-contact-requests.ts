...
export type ZodCustomerContactRequestInsertType = z.infer<
  typeof ZodCustomerContactRequestInsertSchema
>;

export const ZodCustomerContactRequestSelectSchema = createSelectSchema(
  customerContactRequests
);
export type ZodCustomerContactRequestSelectType = z.infer<
  typeof ZodCustomerContactRequestSelectSchema
>;

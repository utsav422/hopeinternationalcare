    ...
    <div className="group flex h-full flex-col rounded-lg bg-white p-5 shadow-lg transition duration-300 hover:scale-105 dark:bg-gray-900 dark:shadow-2xl">
      ...
      <div className="flex flex-grow flex-col space-y-3">
        <div className="flex flex-col items-start">
          {categoryName && (
            <Badge
              className="mb-2 w-fit dark:bg-gray-700 dark:text-gray-200"
              variant="secondary"
            >
              {categoryName}
            </Badge>
          ...
          <Link className="block" href={`/courses/${slug}`}>
            <h3 className="font-semibold text-gray-900 text-xl transition-colors duration-300 group-hover:text-teal-600 dark:text-white dark:group-hover:text-teal-400">
              {title}
            </h3>
          </Link>
        </div>

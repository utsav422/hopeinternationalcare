...
export default function UserDeletionHistory({ isOpen, onClose, userId }: UserDeletionHistoryProps) {
    ...
    const getStatusBadge = (entry: DeletionHistoryEntry) => {
        if (entry.restored_at) {
            return <Badge variant="secondary" className="bg-green-100 text-green-800">Restored</Badge>;
        }
                                            ...
                                            <div className="bg-card border rounded-lg p-4">
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="flex items-center gap-2 text-sm">
                                                        ...
                                                        <Badge variant={entry.email_notification_sent ? "secondary" : "outline"}>
                                                        ...
                                                        <>
                                                            ...
                                                            <div className="space-y-2">
                                                                ...
                                                                <div className="flex items-center gap-2 text-sm">
                                                                    ...
                                                                    <span className="font-medium">Restoration count:</span>
                                                                    <Badge variant="outline">{entry.restoration_count}</Badge>
                                                                </div>
                                                            </div>
                                                        </>
                                                    )}

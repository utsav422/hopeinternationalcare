    ...
    <Card className="dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100">
      <CardHeader>
        <div className="mb-6 space-y-1">
          <CardTitle className="font-medium text-lg dark:text-gray-100">
            {formTitle}
          </CardTitle>
                ...
                render={({ field }) => (
                  <FormItem className="grid grid-cols-1 items-start gap-4 md:grid-cols-4">
                    <div className="space-y-1 md:col-span-1">
                      ...
                      <FormDescription className="text-gray-600 text-xs dark:text-gray-400">
                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          <FormControl>
                            <Button
                              className={cn(
                                'w-full bg-white pl-3 text-left font-normal text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200',
                                !field.value &&
                        ...
                        <PopoverContent
                          align="start"
                          className="w-auto p-0 dark:border-gray-700 dark:bg-gray-800"
                        >
                          <Calendar
                            initialFocus
                            mode="single"
                  ...
                  <FormItem className="grid grid-cols-1 items-start gap-4 md:grid-cols-4">
                    ...
                    <div className="space-y-2 md:col-span-3">
                      <FormControl>
                        <Checkbox
                          checked={!!field.value}
                          className="mr-2 dark:border-gray-600 dark:bg-gray-700 dark:data-[state=checked]:bg-teal-500 dark:data-[state=checked]:text-white"

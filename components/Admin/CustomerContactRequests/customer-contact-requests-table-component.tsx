...
import { useUpdateCustomerContactRequestStatus } from '@/hooks/admin/customer-contact-requests';
...
const columns: ColumnDef<ZodCustomerContactRequestSelectType>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const updateStatusMutation = useUpdateCustomerContactRequestStatus();

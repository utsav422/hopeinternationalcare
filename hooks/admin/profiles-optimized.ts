...
export function useAdminProfileConstraintCheck(id: string) {
    return useQuery({
        queryKey: [...profileQueryKeys.all, 'constraint-check', id],
        queryFn: async () => await adminProfileCheckConstraints(id),

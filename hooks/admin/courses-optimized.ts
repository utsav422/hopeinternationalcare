...
export const courseQueryKeys = {
    ...
    byCategory: (categoryId: string) =>
        [...courseQueryKeys.all, 'category', categoryId] as const,
    byAffiliation: (affiliationId: string) =>
        [...courseQueryKeys.all, 'affiliation', affiliationId] as const,
...
const invalidationPatterns = {
    ...
    onCourseImageUpdate: (id: string) => [courseQueryKeys.detail(id)],
};
...
export function useAdminCourseSearch(search: string) {
    return useQuery({
        queryKey: courseQueryKeys.list({ search, filters: [] }),
        queryFn: async () => adminCourseList({ filters: [], search }),
...
export function useAdminCourseConstraintCheck(id: string) {
    return useQuery({
        queryKey: [...courseQueryKeys.all, 'constraint-check'],
        queryFn: async () => adminCourseCheckConstraints(id),

...
const publicCourseQueryKeys = {
  ...
  list: (params: PublicCourseQueryParams) => [...publicCourseQueryKeys.lists(), params] as const,
  details: () => [...publicCourseQueryKeys.all, 'detail'] as const,
  detail: (id: string) => [...publicCourseQueryKeys.details(), id] as const,
  bySlug: (slug: string) => [...publicCourseQueryKeys.all, 'slug', slug] as const,
  new: () => [...publicCourseQueryKeys.all, 'new'] as const,
  related: (courseId: string, categoryId: string) => [...publicCourseQueryKeys.all, 'related', courseId, categoryId] as const,
};
